...
defmodule KlifeProtocol.Messages.ShareGroupHeartbeat do
  @moduledoc """
  Kafka protocol ShareGroupHeartbeat message
  ...
  - member_epoch: The current member epoch; 0 to join the group; -1 to leave the group. (int32 | versions 0+)
  ...
  - member_id: The member ID is generated by the consumer and provided by the consumer for all requests. (string | versions 0+)
  ...
  - assignment: null if not provided; the assignment otherwise. (Assignment | versions 0+)
      - topic_partitions: The partitions assigned to the member. ([]TopicPartitions | versions 0+)
  ...
  def request_schema(unkown_version),
    do: raise("Unknown version #{unkown_version} for message ShareGroupHeartbeat")
