...
defmodule KlifeProtocol.Messages.ConsumerGroupHeartbeat do
  ...
  - member_id: The member id generated by the consumer. The member id must be kept during the entire lifetime of the consumer process. (string | versions 0+)
  ...
  - subscribed_topic_regex: null if it didn't change since the last heartbeat; the subscribed topic regex otherwise. (string | versions 1+)
  ...
  - member_id: The member id is generated by the consumer starting from version 1, while in version 0, it can be provided by users or generated by the group coordinator. (string | versions 0+)
