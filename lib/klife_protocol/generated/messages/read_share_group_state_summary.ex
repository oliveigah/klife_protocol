...
defmodule KlifeProtocol.Messages.ReadShareGroupStateSummary do
  @moduledoc """
  Kafka protocol ReadShareGroupStateSummary message
  ...
  - topics: The data for the topics. ([]ReadStateSummaryData | versions 0+)
  ...
  - results: The read results ([]ReadStateSummaryResult | versions 0+)
      - topic_id: The topic identifier (uuid | versions 0+)
      - partitions: The results for the partitions. ([]PartitionResult | versions 0+)
          ...
          - state_epoch: The state epoch of the share-partition. (int32 | versions 0+)
          - start_offset: The share-partition start offset. (int64 | versions 0+)
