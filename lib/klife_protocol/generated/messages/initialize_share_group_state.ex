...
defmodule KlifeProtocol.Messages.InitializeShareGroupState do
  @moduledoc """
  Kafka protocol InitializeShareGroupState message
  ...
  - topics: The data for the topics. ([]InitializeStateData | versions 0+)
      ...
      - partitions: The data for the partitions. ([]PartitionData | versions 0+)
          ...
          - start_offset: The share-partition start offset, or -1 if the start offset is not being initialized. (int64 | versions 0+)
  ...
  def request_schema(unkown_version),
    do: raise("Unknown version #{unkown_version} for message InitializeShareGroupState")
