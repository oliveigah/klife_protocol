...
defmodule KlifeProtocol.Messages.RemoveRaftVoter do
  @moduledoc """
  Kafka protocol RemoveRaftVoter message
  ...
  defp request_schema(unkown_version),
    do: raise("Unknown version #{unkown_version} for message RemoveRaftVoter")
