...
defmodule KlifeProtocol.Messages.WriteShareGroupState do
  @moduledoc """
  Kafka protocol WriteShareGroupState message
  ...
  - topics: The data for the topics. ([]WriteStateData | versions 0+)
  ...
  defp request_schema(unkown_version),
    do: raise("Unknown version #{unkown_version} for message WriteShareGroupState")
