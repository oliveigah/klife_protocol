...
defmodule KlifeProtocol.Messages.FetchSnapshot do
  ...
  - topics: The topics to fetch. ([]TopicSnapshot | versions 0+)
      ...
      - partitions: The partitions to fetch. ([]PartitionSnapshot | versions 0+)
          ...
          - snapshot_id: The snapshot endOffset and epoch to fetch. (SnapshotId | versions 0+)
              - end_offset: The end offset of the snapshot. (int64 | versions 0+)
              - epoch: The epoch of the snapshot. (int32 | versions 0+)
          - position: The byte position within the snapshot to start fetching from. (int64 | versions 0+)
          - replica_directory_id: The directory id of the follower fetching. (uuid | versions 1+)
  ...
  - topics: The topics to fetch. ([]TopicSnapshot | versions 0+)
      ...
      - partitions: The partitions to fetch. ([]PartitionSnapshot | versions 0+)
          ...
          - snapshot_id: The snapshot endOffset and epoch fetched. (SnapshotId | versions 0+)
              - end_offset: The snapshot end offset. (int64 | versions 0+)
              - epoch: The snapshot epoch. (int32 | versions 0+)
          - current_leader: The leader of the partition at the time of the snapshot. (LeaderIdAndEpoch | versions 0+)
  ...
  - node_endpoints: Endpoints for all current-leaders enumerated in PartitionSnapshot. ([]NodeEndpoint | versions 1+)
