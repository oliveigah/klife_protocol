defmodule Klife.Protocol.Messages.Heartbeat do
  ...
  defp request_schema(0), do: [group_id: :string, generation_id: :int32, member_id: :string]
  defp request_schema(1), do: [group_id: :string, generation_id: :int32, member_id: :string]
  defp request_schema(2), do: [group_id: :string, generation_id: :int32, member_id: :string]
